...
- Device or Thing Catalog of existing implementations so that you can just copy code (will be hosted in the [project website](https://hololinked.dev/)) or pip installable
